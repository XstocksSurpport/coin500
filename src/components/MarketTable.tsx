    ...
    >
      <div className="flex min-w-0 items-center gap-2">
        <TokenAvatar
          ...
          logo={
            item.logoUrl ??
            (market === "secondary" ? secondaryLogoUrl(item.symbol) : undefined)
          }
        />
      ...
      >
        ...
        />
        <IconBtn icon={<BarChart2 size={14} />} />
        <IconBtn icon={<Bell size={14} />} />
        <IconBtn icon={<Info size={14} />} />
      </div>
...
function IconBtn({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="rounded p-1 text-[#9ca3af] hover:bg-[#f0f3f7] hover:text-[#0051ff]"
    >
      {icon}
    </button>
  );
